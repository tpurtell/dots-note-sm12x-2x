#!/usr/bin/env python3
"""Stream Dots3 semantic workloads with auditable client timings."""
import argparse
import hashlib
...
spec = importlib.util.spec_from_file_location("contracts", Path(__file__).with_name("content_contracts.py"))
...
def main():
    ...
    with args.output.open("x") as destination:
        destination.write(json.dumps({"record": "meta", "schema": "dots3-workloads-v1",
