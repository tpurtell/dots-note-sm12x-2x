...
spec = importlib.util.spec_from_file_location("prefill", Path(__file__).with_name("prefill.py"))
...
def main():
    ...
    parser.add_argument("--depths", type=int, nargs="+", default=[2048, 8192])
    ...
    with args.output.open("x") as output:
        output.write(json.dumps({"record": "meta", "schema": "dots3-context-v1",
