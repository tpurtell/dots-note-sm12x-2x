...
prefill = module("prefill", "prefill.py")
workloads = module("workloads", "workloads.py")
...
def main():
    ...
    parser.add_argument("--filler-tokens", type=int, nargs="+", default=[2048, 8192])
    ...
    with args.output.open("x") as output:
        output.write(json.dumps({"record": "meta", "schema": "dots3-context-retrieval-v1",
