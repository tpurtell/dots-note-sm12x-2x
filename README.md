...
Start from [vLLM v0.30.0](https://github.com/vllm-project/vllm/releases/tag/v0.30.0), the latest stable release checked on 2026-09-23. Native Dots3 Note support entered through [#51255](https://github.com/vllm-project/vllm/pull/51255); review [Dots3 runtime optimization #53517](https://github.com/vllm-project/vllm/pull/53517) against that tag before adding B12x kernels. The recipe targets two GB10 GPUs at tensor parallel size 2 and approximately **85% GPU memory utilization**, subject to a measured unified-memory budget and successful startup.
